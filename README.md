...
Filtro rápido por status (Pendentes / Concluídas)

Barra de progresso baseada na taxa de conclusão do dia

Interface responsiva com menu lateral retrátil

Tecnologias
Front-end: HTML5, CSS3, JavaScript (ES6+)

Back-end: Node.js (Express) e Python (Flask)
